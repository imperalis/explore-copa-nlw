function createGame(player1, hour, player2){
    return `
    <li>
        <img src="./assets/icon-${player1}.png" alt="Bandeira do ${player1}">
        <strong>${hour}</strong>
        <img src="./assets/icon-${player2}.png" alt="Bandeira do ${player2}">
    </li>
    `
}
...
document.querySelector("#cards").innerHTML =
  ...
  createCard(
    ...
    createGame("morocco", "07:00", "croatia") +
      createGame("deutschland", "10:00", "japan") +
  ...
  createCard(
    ...
    createGame("japan", "07:00", "costaRica") +
      ...
      createGame("spain", "16:00", "deutschland")
  ) +
  createCard(
    "28/11",
    "segunda",
  ...
  createCard(
    ...
    createGame("croatia", "12:00", "belgium") +
      ...
      createGame("costaRica", "16:00", "deutschland")
  ) +
  createCard(
    "02/12",
    "sexta",
